...
export const oncVerifyTotalVolumeIvSet: WorkflowDef = {
	...
	outro: [
		'The total volume reads true. Concentration, dose, and math all agree.',
	],
	steps: [
		{
			...
			prompt:
				'This order needs a total-volume IV set, not a plain product. Find it.',
			aidRef: 'p.11 step 4',
			...
			correct:
				'riTUXimab (Ruxience) _ mg rapid infusion in NaCl 0.9% 250 mL total volume',
			wrong: [
		...
		},
		{
			...
			prompt:
				"A prompt appears because the dose doesn't match the bag's dispensing strength. Answer it.",
			aidRef: 'p.11 note',
		...
		},
		{
			...
			location:
				'Verify Intermittent Protocol Order Day 1 — sodium chloride dose',
			prompt:
