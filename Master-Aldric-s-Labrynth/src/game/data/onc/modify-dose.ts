...
export const oncModifyDose: WorkflowDef = {
	...
	outro: [
		'Adjusted, reasoned, signed. The Target Dose stands untouched for next time.',
	],
	steps: [
		{
			...
			prompt:
				"Navigate to this patient's chemotherapy Powerplan to adjust a dose.",
			aidRef: 'p.18 step 1',
			...
			wrong: [
				{ label: 'ONC LY CHOP + riTUXimab' },
				{ label: 'Document In Plan' },
			],
		},
		{
			...
			prompt:
				'The order is not yet signed. Open the tool that lets you adjust its dose safely.',
			aidRef: 'p.18 step 2',
		...
		},
		{
			...
			prompt:
				'The oncologist wants a 5% dose reduction, discussed and documented. Adjust the dose without disturbing the Target Dose.',
			aidRef: 'p.19 step 3',
		...
		},
		{
			...
			prompt:
				'The dose adjustment is applied and reasoned. Finalize the order.',
			aidRef: 'p.19 step 4',
