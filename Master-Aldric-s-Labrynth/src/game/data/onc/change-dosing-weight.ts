...
export const oncChangeDosingWeight: WorkflowDef = {
	...
	outro: [
		'The banner reads true again. Every weight-based dose from here follows the new number.',
	],
	steps: [
		{
			...
			prompt:
				"The patient's Dosing Weight on the Banner Bar is out of date. Update it — either method reaches the same result.",
			aidRef: 'p.24',
		...
		},
		{
			...
			wrong: [
				{ label: 'Dosing Weight Reviewed' },
				{ label: 'Dosing Weight Adjustment Needed' },
			],
		},
		{
			...
			wrong: [
				{ label: 'Patient Stated Height/Length' },
		...
		},
		{
			...
			prompt:
				'The new weight is signed but the banner still shows the old one. Bring it current.',
			aidRef: 'p.24',
