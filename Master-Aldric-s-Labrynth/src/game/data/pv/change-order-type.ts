...
export const pvChangeOrderType: WorkflowDef = {
	...
	outro: [
		'The order now wears its correct shape — no more, no less than it needs.',
	],
	steps: [
		{
			...
			prompt:
				"PowerChart couldn't determine whether this dalteparin order is a plain med, intermittent, or continuous. Pick correctly.",
			aidRef: 'p.11',
		...
		},
		{
			...
			prompt:
				"This ondansetron order is defaulting to an order type that wants total volume, rate and infuse-over instructions it doesn't need. Fix the order type itself.",
			aidRef: 'p.12 step 1',
		...
		},
		{
			...
			prompt:
				'The window is now the more appropriate "Verify Med Window" for this IV-direct order. Finalize it.',
			aidRef: 'p.13 step 3',
