	...
	return (
		...
		>
			...
			<g transform="translate(596,196)">
				...
				<path
					d="M-30 0 Q-16 -14 0 -6 Q16 -14 30 0 L30 4 Q16 -9 0 -2 Q-16 -9 -30 4 Z"
					fill="#e2ddd0"
					opacity="0.85"
				/>
			...
			<g transform="translate(268,110)">
				<path
					d="M-96 250 Q-96 150 -40 118 Q-10 104 20 104 Q50 104 80 118 Q140 150 140 250 Z"
					fill="url(#ac-robe)"
				/>
				...
				<path
					d="M-58 132 Q-70 60 17 40 Q104 60 92 132 Q60 108 17 108 Q-26 108 -58 132 Z"
					fill="url(#ac-hood)"
				/>
				...
				<path
					d="M14 158 q4 8 -2 14 q-6 -6 -2 -14z"
					fill="#8a7f66"
					opacity="0.8"
				/>
				...
				<g transform="translate(-106,78)">
					<path
						d="M0 8 q-10 -14 2 -20 q12 -6 16 6 q3 12 -8 16 z"
						fill="#e6c39a"
					/>
			...
			<g transform="translate(452,258)">
				<g transform="translate(0,86)">
					...
					<path
						d="M-30 0 q10 -34 16 -12 q6 -30 16 -6 q8 -22 14 4 q6 16 -14 20 q-30 4 -32 -6z"
						fill="url(#ac-fire)"
					/>
					<ellipse
						cx="0"
				...
				<path
					d="M-80 -14 Q-72 -54 -34 -58 Q0 -78 34 -58 Q74 -54 80 -14 Q0 4 -80 -14 Z"
					fill="#9BF0C8"
					opacity="0.92"
				/>
				...
				<path
					d="M-80 -18 Q-102 22 -96 74 Q-84 82 -78 74 Q-86 26 -66 -8 Z"
					fill="#3fae82"
					opacity="0.9"
				/>
				<path
					d="M80 -18 Q104 26 98 74 Q86 82 80 74 Q90 28 66 -8 Z"
					fill="#3fae82"
					opacity="0.9"
				/>
