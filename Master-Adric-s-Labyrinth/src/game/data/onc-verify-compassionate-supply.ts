  ...
  steps: [
    {
      ...
      prompt: 'This patient is receiving compassionate supply. Choose the matching IV set.',
      aidRef: 'p.17 step 4',
    ...
    },
    {
      ...
      prompt: 'The compassionate supply IV set is selected. Finalize the verification.',
