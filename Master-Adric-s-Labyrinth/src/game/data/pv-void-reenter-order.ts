	...
	steps: [
		{
			...
			prompt:
				'This Forxiga order was entered as a Template Non-Formulary in error, and needs to be voided rather than verified. Back out first.',
			aidRef: 'p.24 step 1',
		...
		},
		{
			...
			prompt:
				'Select the action that removes this order entirely, without dispensing it.',
			aidRef: 'p.24 step 2',
		...
		},
		{
			...
			prompt:
				'State why this order is being voided, and make sure nothing prints.',
			aidRef: 'p.24 step 3',
		...
		},
		{
			...
			prompt:
				'Enter the medication that was actually intended, dapagliflozin, in place of the voided one.',
			aidRef: 'p.25 step 5',
		...
		},
		{
			...
			location: 'Verify window',
			prompt:
				'Keep the original prescriber listed, confirm communication type, and finalize.',
