  ...
  steps: [
    {
      ...
      prompt: 'A vasopressin continuous infusion is needed — not the titratable version.',
      ...
      correct: 'vasopressin continuous infusion (0.4 units/mL) in NaCl 0.9% 50 mL syringe (preferred)',
      wrong: [
        {
          label: 'vasopressin NEO cont 0.16 units/mL (less than or equal to 3 kg) in NaCl 0.9% 20 mL',
        ...
        {
          label: 'vasopressin PED Diabetes Insipidus cont 0.16 units/mL in NaCl 0.9% 100 mL',
          rule: 'NEO or PED IV sets are pediatric and neonatal only — adult orders will not have that naming. Select the adult continuous infusion instead.',
          source: 'job-aid',
          aidRef: 'p.38 step 2 note',
        },
    ...
    },
    {
      ...
      prompt: 'There are no starting, min/max or titration fields to fill here — this is a fixed continuous rate. Finalize the order.',
      aidRef: 'p.39 step 4',
    ...
    },
    {
      ...
      prompt: 'The Infusion Instructions became the Order Comments. Find the field that tells you when the bag will actually run out.',
      aidRef: 'p.39 step 6',
