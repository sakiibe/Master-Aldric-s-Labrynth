	...
	steps: [
		{
			...
			prompt:
				'STAT and NOW orders need verifying first. Begin working this cefazolin order.',
			aidRef: 'p.1 step 1',
		...
		},
		{
			...
			prompt:
				'An auto-product was assigned to the IV set, but this order needs the pre-mixed bag instead. Confirm the correct product.',
			aidRef: 'p.1 step 3',
		...
		},
		{
			...
			prompt:
				'Move the pre-mixed bag into the selected products, then remove what auto-selected in its place.',
			aidRef: 'p.2',
		...
		},
		{
			...
			prompt:
				'The pre-mixed bag already contains its own diluent. Remove the separate sodium chloride line so the total volume is correct.',
			aidRef: 'p.2',
		...
		},
		{
			...
			prompt:
				'Nothing about the drug identity itself should change here — only the dose, via Modify.',
			aidRef: 'p.3',
		...
		},
		{
			...
			prompt:
				"The prescriber wants this re-assessed in 5 days. Document that so it's face-up on the MAR.",
			aidRef: 'p.3',
		...
		},
		{
			...
			prompt:
				'This is an antimicrobial — a specific field is mandatory. Complete it.',
			aidRef: 'p.4',
