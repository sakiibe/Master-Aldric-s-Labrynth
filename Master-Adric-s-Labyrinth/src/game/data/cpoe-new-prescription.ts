...
export const cpoeNewPrescription: WorkflowDef = {
  ...
  outro: ['A prescription conjured from nothing but a name and a dose. Prescribed, and sent on.'],
  steps: [
    {
      id: 'set-type-prescriptions',
      location: 'Add Order Search box',
      prompt: 'This medication is not being ordered as an inpatient order — it needs to leave with the patient. Set the search accordingly.',
      ...
      wrong: [{ label: 'Type: Inpatient' }, { label: 'Type: Document Medication by Hx' }],
    },
    {
      id: 'search-miscellaneous',
      location: 'Add Order Search box — Prescriptions',
      prompt: 'The medication cannot be found by name. Find the free-text fallback.',
      aidRef: 'p.19 step 3',
    ...
    },
    {
      ...
      prompt: 'Enter the drug name, dose, route and frequency, and select where the prescription is sent.',
      aidRef: 'p.19 step 3',
    ...
    },
    {
      ...
      wrong: [{ label: 'Dispense From location' }, { label: 'Billing formula' }],
    },
  ],
};
