  ...
  steps: [
    {
      ...
      prompt: 'A new systemic therapy order sits in Future status, awaiting first verification. Begin.',
    ...
    },
    {
      ...
      prompt: 'Medication Manager already defaulted the action for you. Begin the verification.',
    ...
    },
    {
      ...
      prompt: 'This is a Cutover migration, not a live clinical order. Select the correct facility and location.',
    ...
    },
    {
      ...
      prompt: 'The order still needs to flow to Pharmacy Patient Monitor for its second verification. Finish the first verification.',
      aidRef: 'p.6 step 8',
    ...
    },
    {
      ...
      location: 'Pharmacy Patient Monitor',
      prompt: 'The order is now Active and needs its second verification. Begin.',
      aidRef: 'p.7 step 1',
    ...
    },
    {
      id: 'second-verify-ok',
      location: 'Verify Intermittent Protocol Order Day 1',
      prompt: 'All required information is reviewed for the second verification. Finalize it.',
      aidRef: 'p.8 step 4',
