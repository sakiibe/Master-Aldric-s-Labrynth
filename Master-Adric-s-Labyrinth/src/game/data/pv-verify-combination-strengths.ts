...
export const pvVerifyCombinationStrengths: WorkflowDef = {
  ...
  outro: ['Two orders, two strengths, one dose — and the ledger stays honest either way.'],
  steps: [
    {
      id: 'modify-dose-first-strength',
      location: 'New Med Order — lamoTRIgine',
      prompt: "A 125 mg dose doesn't divide evenly onto one strength. Rather than combine two products on one order, split it — start by fixing this order's dose to one strength.",
      aidRef: 'p.34 step 4',
    ...
    },
    {
      ...
      prompt: 'Change this order to the 25 mg tablet, one component of the combination.',
      aidRef: 'p.34',
    ...
    },
    {
      ...
      wrong: [{ label: 'lamoTRIgine 150 mg tablet' }, { label: 'lamoTRIgine 25 mg tablet' }],
    },
    {
      id: 'match-admin-time-and-comment',
      location: 'New Med Order — 100 mg order',
      prompt: 'This order must line up with the 25 mg one, and carry its own note about the combination.',
      aidRef: 'p.35',
