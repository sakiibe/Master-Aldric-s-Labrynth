  ...
  steps: [
    {
      ...
      prompt: 'This norepinephrine infusion needs to titrate to target blood pressure, not run at one fixed rate.',
      ...
      correct: 'norepinephrine (central line) titratable infusion (240 mcg/mL) in NaCl 0.9% 250 mL',
      wrong: [
        {
          label: 'norepinephrine PED cont 0.008 mg/mL (greater than 2kg to 20kg) in D5W 30mL',
        ...
        { label: 'norepinephrine (resus) titratable infusion (16 mcg/mL) in NaCl 0.9% 250 mL' },
      ],
    },
    {
      id: 'enter-infusion-instructions-titrate',
      location: 'Continuous Details — Rate',
      prompt: 'The Rate field is already free-text "Titrate". Add any other infusion instructions in the box below it.',
      aidRef: 'p.41 step 3',
    ...
    },
    {
      ...
      prompt: 'The minimum, maximum, and titration instructions are pre-populated. Add only the starting dose, then finalize.',
      aidRef: 'p.41 step 4',
    ...
    },
    {
      ...
      prompt: 'The Rate field is greyed out with a free-text "Titrate". Check that the titration instructions themselves are appropriate before signing off.',
    ...
    },
    {
      ...
      prompt: 'The titration instructions check out. Finalize the verification.',
      aidRef: 'p.43 step 8',
