  ...
  steps: [
    {
      ...
      prompt: 'Changing the vial strength in this IV set will wipe its Product Notes and Fill Notes. Preserve the Fill Notes first.',
      aidRef: 'p.26 step 1',
    ...
    },
    {
      ...
      prompt: 'Select the correct vial strengths for the new dose and move them across.',
    ...
    },
    {
      ...
      prompt: 'Update each product’s dose to match the calculated total. Take care with the click.',
      aidRef: 'p.27 step 4',
    ...
    },
    {
      ...
      prompt: 'The IV set’s Product Notes were wiped by the product change. Restore them from what was copied earlier.',
      aidRef: 'p.27 step 5',
    ...
    },
    {
      ...
      location: 'Verify window — Sequence / Dispense category / Dispense from location',
      prompt: 'Confirm the fields that route this order correctly before verifying.',
      aidRef: 'p.27 step 7',
      ...
      wrong: [{ label: 'Sequence: INJECTION' }, { label: 'Sequence: COMPOUND' }],
    },
  ],
};
