...
export const cpoeSelfAdministeredMeds: WorkflowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      prompt: 'Select the medications and reason, then submit the self-med request.',
      ...
      wrong: [{ label: 'Self-Administered Medication' }, { label: 'Patient Declined', needsReview: true }],
    },
  ],
};
