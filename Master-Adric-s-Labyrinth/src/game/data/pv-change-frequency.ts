  ...
  steps: [
    {
      ...
      prompt: 'Frequencies are tied to Standard Medication Administration Times (SMAT). Two very different situations call for changing them.',
      aidRef: 'pp.13-16',
    ...
    },
    {
      ...
      prompt: 'This cefazolin order needs its task times calculated from the order start time, not the standard q8h clock.',
      aidRef: 'p.14 step 2',
    ...
    },
    {
      ...
      prompt: 'This HYDROmorphone order should not display or task nursing as "overdue".',
      aidRef: 'p.16 step 2',
