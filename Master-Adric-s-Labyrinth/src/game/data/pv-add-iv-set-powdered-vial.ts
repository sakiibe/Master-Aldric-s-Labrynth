  ...
  steps: [
    {
      ...
      prompt: 'Search for vancomycin and pick the adult peripheral IV set for this dose range.',
      ...
      wrong: [
        {
          label: 'vancomycin central line (doses 1.75 to 2 g) in NaCl 0.9% 1000 mL',
    ...
    },
    {
      ...
      prompt: 'The dose field is blank because this is a powdered vial with no set volume. Enter it.',
      aidRef: 'p.30 step 3',
    ...
    },
    {
      ...
      prompt: 'This powdered vial has no volume of its own. Decide how to handle the Total volume field, per the reconstitution guidance.',
      aidRef: 'p.31 step 5',
    ...
    },
    {
      ...
      prompt: 'Set the infusion rate — for peripheral IVs, this comes from the dosing guidelines, not a guess.',
      aidRef: 'p.31-32',
    ...
    },
    {
      ...
      prompt: 'Everything is complete. Finalize — remember, orders entered via Medication Manager verify automatically.',
      aidRef: 'p.33 step 6',
