	...
	steps: [
		{
			...
			prompt:
				'The patient is being admitted to Medicine. Find the admission order set.',
		...
		},
		{
			...
			wrong: [
				{ label: 'Interprofessional Consults' },
		...
		},
		{
			...
			prompt:
				'The order selections are complete. Activate the orders now, rather than leaving them planned.',
			aidRef: 'p.10 step 5',
		...
		},
		{
			...
			prompt:
				'The Powerplan is initiated. Move to review and sign the orders it placed.',
			aidRef: 'p.10 step 6',
