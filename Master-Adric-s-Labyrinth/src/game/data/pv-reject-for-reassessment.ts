	...
	steps: [
		{
			...
			prompt:
				'This caspofungin dose looks off for an unclear indication. Investigate before acting.',
		...
		},
		{
			...
			prompt:
				'The dose is not appropriate and needs the prescriber to reassess it. Decline the order rather than verifying it.',
			aidRef: 'p.27 step 5',
		...
		},
		{
			...
			prompt:
				'Complete the rejection — it will route to the prescriber’s Message Center.',
			aidRef: 'p.27 step 6',
		...
		},
		{
			...
			prompt:
				'The prescriber responds with a corrected order over the phone. Receive it and clean up the rejected one.',
