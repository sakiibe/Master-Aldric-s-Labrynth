  ...
  steps: [
    {
      ...
      prompt: "An error appears on clicking OK — the dose's units don't work for this field. Acknowledge it first.",
      aidRef: 'p.51 step 1',
    ...
    },
    {
      ...
      prompt: 'This dextrose 50% order needs its dose expressed in mL, not g. Fix the units.',
      aidRef: 'p.51 step 2',
