...
export const cpoeAddOrder: WorkflowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      correct: '+ Add',
      wrong: [{ label: 'Reconciliation' }, { label: 'Document Medication by Hx' }],
    },
    {
      id: 'set-order-type',
      location: 'Add Order Search box',
      prompt: 'Before searching, confirm the search will return inpatient orders.',
      aidRef: 'p.1 step 2',
    ...
    },
    {
      id: 'finish-search',
      location: 'Add Order Search box',
      prompt: 'The order sits selected behind the search window. Close the search.',
      aidRef: 'p.1 step 4',
