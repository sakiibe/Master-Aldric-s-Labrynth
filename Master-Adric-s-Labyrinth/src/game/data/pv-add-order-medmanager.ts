...
export const pvAddOrderMedManager: WorkflowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      wrong: [{ label: 'ramipril 2.5 mg capsule' }, { label: 'ramipril 10 mg capsule' }],
    },
    {
      id: 'update-dose',
      location: 'New Med Order',
      prompt: 'The dose is correct as populated. Commit it — remember, any dose change needs a unit of measure.',
      aidRef: 'p.6 step 3',
