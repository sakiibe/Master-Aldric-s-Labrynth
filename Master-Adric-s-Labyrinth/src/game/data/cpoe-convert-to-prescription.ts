...
export const cpoeConvertToPrescription: WorkflowDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      prompt: 'This is a discharge reconciliation, so the prescription must be printed rather than sent electronically.',
      aidRef: 'p.18 step 1',
    ...
    },
    {
      ...
      wrong: [{ label: 'Orders For Signature' }, { label: 'Orders For Nurse Review' }],
    },
  ],
};
