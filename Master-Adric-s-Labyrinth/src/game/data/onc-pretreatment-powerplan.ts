  ...
  steps: [
    {
      ...
      prompt: 'A new patient is starting LY CHOP therapy. Find the pre-treatment plan.',
      aidRef: 'p.20 step 2',
    ...
    },
    {
      ...
      prompt: "This is a future outpatient visit, not today's visit. Set it up correctly.",
      aidRef: 'p.21 step 3',
    ...
    },
    {
      ...
      prompt: 'A blue X marks the prescriptions still missing required details. Begin completing them.',
    ...
    },
    {
      ...
      prompt: 'This prescription needs to go to the community pharmacy. Complete the remaining details.',
      aidRef: 'p.22 step 7',
    ...
    },
    {
      ...
      prompt: 'Every phase of this plan shares the same diagnosis. Apply it everywhere at once rather than phase by phase.',
      aidRef: 'p.22 step 10',
