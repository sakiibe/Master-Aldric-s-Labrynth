...
export const pvBuildIvSetMedManager: WorkflowDef = {
  ...
  outro: ['A proper compounded bag, built from its parts. The stand-in order is gone.'],
  steps: [
    {
      id: 'cancel-if-template-nonform',
      location: 'Medication Manager',
      prompt: 'This TNF-KCl order was placed as a Template Non-Formulary, but a real IV set should be built instead. Back out of it first.',
      aidRef: 'p.46 step 2',
    ...
    },
    {
      ...
      prompt: 'Search for the main component of the IV set you’re about to build.',
      aidRef: 'p.46 step 3',
    ...
    },
    {
      ...
      prompt: 'This will be a continuous infusion, not a plain med or intermittent dose.',
      aidRef: 'p.46 step 4',
    ...
    },
    {
      ...
      prompt: 'Enter the total volume, but leave the rate-per-weight field alone — it doesn’t apply here.',
      aidRef: 'p.47',
    ...
    },
    {
      ...
      prompt: 'Set the pump rate, then add the second component of this IV set.',
      aidRef: 'p.47',
    ...
    },
    {
      ...
      prompt: 'Note why this was built as a compounded IV rather than the Template Non-Formulary it was ordered as.',
      aidRef: 'p.48',
    ...
    },
    {
      ...
      prompt: 'The original Template Non-Formulary order is now redundant. Remove it without dispensing it.',
      aidRef: 'p.49 step 5',
