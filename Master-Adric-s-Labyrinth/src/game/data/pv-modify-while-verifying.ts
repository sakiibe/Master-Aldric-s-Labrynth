  ...
  steps: [
    {
      ...
      prompt: 'A verbal clarification changed this ondansetron order from PRN to scheduled. Begin correcting it in place.',
      aidRef: 'p.20 step 1',
    ...
    },
    {
      ...
      prompt: 'This medication was ordered as IV, not IV direct. Change it to the route actually intended.',
      aidRef: 'p.21',
    ...
    },
    {
      ...
      prompt: 'Change this order from PRN to scheduled, with a 48-hour prompt to reassess rather than a hard cutoff.',
      aidRef: 'p.21 step 3',
    ...
    },
    {
      ...
      prompt: 'This clarification came from you, the verifying pharmacist. Reflect that.',
      aidRef: 'p.22 step 4',
