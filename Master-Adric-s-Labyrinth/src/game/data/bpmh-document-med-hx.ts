  ...
  steps: [
    {
      ...
      prompt: 'Open the part of the chart where home medications are documented.',
      aidRef: 'p.1 step 1',
    ...
    },
    {
      ...
      prompt: 'The patient reports taking two medications at home. Begin adding them.',
      aidRef: 'p.1 step 3',
    ...
    },
    {
      ...
      prompt: 'Before searching, make sure the search will return home medications.',
      aidRef: 'p.1 step 4',
    ...
    },
    {
      ...
      prompt: 'The patient takes sertraline 25 mg by mouth, once daily. Choose the entry to add.',
      aidRef: 'p.1 step 5',
    ...
    },
    {
      ...
      prompt: 'Dose, route and frequency need to be confirmed for the first medication.',
      aidRef: 'p.1 step 8',
    ...
    },
    {
      ...
      prompt: 'The patient is still taking it as prescribed, last dose yesterday at 08:00. Where does that go?',
      aidRef: 'p.2 step 9',
    ...
    },
    {
      id: 'document-history',
      location: 'Document Medication by Hx window',
      prompt: 'Every medication is now accurate and complete. Commit the history.',
      aidRef: 'p.2 step 10',
    ...
    },
    {
      ...
      prompt: 'Pull up the list of documented home medications to check your work.',
      aidRef: 'p.2 step 11',
