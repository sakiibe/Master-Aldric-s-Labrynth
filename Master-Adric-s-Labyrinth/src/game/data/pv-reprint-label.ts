...
export const pvReprintLabel: WorkflowDef = {
  ...
  outro: ['A fresh label, same dispense, same barcode. Nothing was duplicated.'],
  steps: [
    {
      id: 'select-history-action',
      location: 'Action column',
      prompt: 'A label needs reprinting for this multivitamin order. Pick the right action — not the one that sounds obvious.',
      aidRef: 'p.19 step 2',
