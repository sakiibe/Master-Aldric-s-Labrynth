	...
	steps: [
		...
		},
		{
			...
			wrong: [
				{
					label:
						'fentanyl NEO/PED titrate infusion 10 mcg/mL in NaCl 0.9% 25 mL syringe',
		...
		},
		{
			...
			prompt:
				'The Rate field needs to reflect that this is a titrated infusion.',
			aidRef: 'p.5 step 4',
