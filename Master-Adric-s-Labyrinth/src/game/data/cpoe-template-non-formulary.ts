  ...
  steps: [
    {
      ...
      prompt: 'The medication cannot be found as a standard order. Search for the free-text alternative.',
    ...
    },
    {
      ...
      prompt: 'A dialog warns that this free-text drug cannot be checked for interactions. Acknowledge it.',
      aidRef: 'p.9 step 6',
