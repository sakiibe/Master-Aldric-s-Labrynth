...
export const oncVerifyInfusor: WorkflowDef = {
  ...
  outro: ['Sealed, timed, labelled. It will keep working long after you’ve gone home.'],
  steps: [
    {
    ...
    },
    {
      ...
      correct: [
        { label: 'fluorouracil 3600 mg/230 mL D5W prefilled infusor (outsourced)', next: 'verify-infusor-ok' },
      ],
      wrong: [
        { label: 'fluorouracil 3200 mg/230 mL D5W prefilled infusor (outsourced)' },
        { label: 'fluorouracil 4000 mg/230 mL D5W prefilled infusor (outsourced)' },
      ],
    },
    {
      id: 'select-compounded-infusor',
      location: 'Manual Product Select — IV Sets tab',
      prompt: 'Select the compounded infusor IV set and calculate the diluent volume.',
      aidRef: 'p.14 step 4',
      ...
      correct: [
        { label: 'fluorouracil _ mg over 46h in D5W 230 mL total volume infusor', next: 'verify-infusor-ok' },
      ],
      wrong: [
    ...
    },
    {
      ...
      prompt: 'The infusor’s volume and duration are set. Finalize the verification.',
      aidRef: 'p.14 step 5',
