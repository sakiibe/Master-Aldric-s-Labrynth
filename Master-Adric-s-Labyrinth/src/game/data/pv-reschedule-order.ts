  ...
  steps: [
    {
      ...
      prompt: 'The Order Comments advise giving this dalteparin at 18:00 instead of its default time. Notice where that instruction lives.',
      aidRef: 'p.17 step 1',
    ...
    },
    {
      ...
      prompt: "The standard daily frequency doesn't give this specific time. Switch to something that will.",
      aidRef: 'p.17 step 2',
    ...
    },
    {
      ...
      prompt: 'This order is already verified and now needs rescheduling after the fact.',
