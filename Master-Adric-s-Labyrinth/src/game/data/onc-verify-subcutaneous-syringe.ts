	...
	steps: [
		{
			...
			prompt:
				"Subcutaneous syringes are built as IV sets too. Make sure you're selecting from the right tab.",
			aidRef: 'p.15 step 4',
		...
		},
		{
			...
			prompt:
				"Double-check the Dispense category before verifying — it's easy to assume a subcutaneous route changes it.",
			aidRef: 'p.16 note',
		...
		},
		{
			...
			location: 'Verify Intermittent Protocol Order Days 1 to 7',
			prompt:
				'Review the relevant information, check the Comments for any additional notes, and finalize.',
			aidRef: 'p.16 step 5',
