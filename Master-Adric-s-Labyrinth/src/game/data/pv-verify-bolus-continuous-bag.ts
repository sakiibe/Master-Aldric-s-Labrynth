...
export const pvVerifyBolusContinuousBag: WorkflowDef = {
  ...
  outro: ['One extra measure, drawn from the running drip, properly accounted for.'],
  steps: [
    {
      id: 'process-bolus-order',
      location: 'Pharmacy Patient Monitor',
      prompt: 'A bolus is ordered off an already-running continuous infusion. Begin.',
      aidRef: 'p.43 step 1',
    ...
    },
    {
      ...
      prompt: 'The continuous infusion itself (a titratable order) is also on this list — begin its verification too, reviewing its dose range in Comments.',
    ...
    },
    {
      ...
      prompt: 'The bolus order displays as a separate Med order. Select its product.',
      aidRef: 'p.44 step 4',
    ...
    },
    {
      ...
      prompt: 'If this defaulted to an Intermittent order instead of a Med order, fix that before verifying.',
      aidRef: 'p.44 step 5',
