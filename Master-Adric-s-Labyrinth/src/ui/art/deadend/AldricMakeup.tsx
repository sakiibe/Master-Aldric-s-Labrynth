  ...
  return (
    <svg viewBox="0 0 690 440" width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
      ...
      <g transform="translate(292,116)">
        <path d="M-96 250 Q-96 158 -40 122 Q-10 108 20 108 Q50 108 80 122 Q140 158 140 250 Z" fill="url(#am-robe)" />
        ...
        <path d="M-50 126 Q17 150 84 126 Q92 158 78 178 Q17 196 -44 178 Q-58 158 -50 126 Z" fill="#e2ddd0" opacity="0.9" />

        <path d="M-58 136 Q-76 92 -34 84 Q-20 108 17 110 Q54 108 68 84 Q110 92 92 136 Q60 112 17 112 Q-26 112 -58 136 Z" fill="#2f4a56" />
        ...
        <path d="M-14 34 Q17 20 48 34 Q46 44 17 42 Q-12 44 -14 34 Z" fill="#e2ddd0" />
        <path d="M-17 44 q-10 -8 -5 -20 q7 8 14 8 z" fill="#e2ddd0" />
        <path d="M51 44 q10 -8 5 -20 q-7 8 -14 8 z" fill="#e2ddd0" />

        {/* LEFT eye: fully done */}
        <path d="M-3 50 q9 -5 17 -1 l7 -5 l-5 7 q1 6 -8 7 q-10 1 -11 -8 z" fill="#7a4a8a" opacity="0.55" />
        <ellipse cx="5" cy="54" rx="4.8" ry="4" fill="#fff" />
        <circle cx="6" cy="54.5" r="2.4" fill="#3a5a4a" />
        <path d="M-3 50 q9 -6 17 -2 l9 -6" stroke="#1c1410" strokeWidth="2.6" fill="none" strokeLinecap="round" />
        ...
        <path d="M-4 40 q10 -8 20 -2" stroke="#1c1410" strokeWidth="3.4" fill="none" strokeLinecap="round" />

        {/* RIGHT eye: entirely bare */}
        <ellipse cx="30" cy="54" rx="4.8" ry="4" fill="#fff" />
        <circle cx="29" cy="54.5" r="2.4" fill="#3a5a4a" />
        <path d="M21 43 q10 -5 20 1" stroke="#d8d2c4" strokeWidth="4" fill="none" strokeLinecap="round" />
        ...
        <path d="M31 108 q6 22 -2 40" stroke="#c9c2b2" strokeWidth="6" fill="none" strokeLinecap="round" />
        ...
        <g>
          <path d="M-3 76 q7 -13 11 -3 q5 -8 9 -2 q4 -6 9 2 q3 -9 11 3 q-8 4 -20 4 q-12 0 -20 -4 z" fill="#a8324a" />
          <path d="M-3 76 q7 20 20 20 q13 0 20 -20 q-8 5 -20 5 q-12 0 -20 -5 z" fill="#c4415c" />
          <path d="M4 70 q4 -6 7 -1" stroke="#e88aa0" strokeWidth="2.4" fill="none" strokeLinecap="round" opacity="0.85" />
          <ellipse cx="12" cy="86" rx="6" ry="2.6" fill="#e88aa0" opacity="0.6" />
          <path d="M33 78 q7 0 10 4" stroke="#c4415c" strokeWidth="2.6" fill="none" strokeLinecap="round" opacity="0.75" />
        </g>

        {/* LEFT arm: hand mirror */}
        <path d="M-52 150 q-42 6 -58 -18" stroke="#e6c39a" strokeWidth="15" fill="none" strokeLinecap="round" />
        <g transform="translate(-118,124) rotate(-12)">
          <rect x="-5" y="6" width="10" height="34" rx="4" fill="url(#am-brass)" />
          <ellipse cx="0" cy="-10" rx="26" ry="30" fill="url(#am-brass)" />
          <ellipse cx="0" cy="-10" rx="20" ry="24" fill="url(#am-glassy)" />
          <path d="M-13 -24 q10 6 8 20" stroke="#eaf2f4" strokeWidth="4" fill="none" opacity="0.75" strokeLinecap="round" />
        </g>

        {/* RIGHT arm: kohl stick */}
        <path d="M84 150 q40 -4 52 -34" stroke="#e6c39a" strokeWidth="15" fill="none" strokeLinecap="round" />
