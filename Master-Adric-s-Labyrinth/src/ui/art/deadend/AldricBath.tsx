  ...
  return (
    <svg viewBox="0 0 690 440" width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
      ...
      <g transform="translate(78,96)">
        ...
        <path d="M-14 13 Q-20 78 -8 104 Q0 112 8 104 Q20 78 14 13 Z" fill="#3a5a68" opacity="0.9" />
      </g>

      {/* steam wisps */}
      <g stroke="#e8e2d0" strokeWidth="2.5" fill="none" opacity="0.22" strokeLinecap="round">
      ...
      <g transform="translate(300,120)">
        ...
        <path d="M-14 30 Q17 16 48 30 Q46 40 17 38 Q-12 40 -14 30 Z" fill="#e2ddd0" opacity="0.85" />
        <path d="M-6 36 q10 -9 20 -3" stroke="#d8d2c4" strokeWidth="4" fill="none" strokeLinecap="round" />
        <path d="M20 33 q10 -6 20 3" stroke="#d8d2c4" strokeWidth="4" fill="none" strokeLinecap="round" />
        ...
        <path d="M17 54 q-4 8 -1 12 q3 2 6 0" stroke="#c99a72" strokeWidth="2" fill="none" />
        <path d="M8 74 q9 3 18 0" stroke="#a06a4a" strokeWidth="2.5" fill="none" strokeLinecap="round" />
        <path d="M-6 68 Q17 82 40 68 Q44 108 30 132 Q17 148 4 132 Q-10 108 -6 68 Z" fill="#e2ddd0" />
        <g stroke="#c9c2b2" strokeWidth="1.5" fill="none" opacity="0.7">
          <path d="M4 82 Q10 112 12 134" />
          <path d="M24 82 Q22 112 22 134" />
        </g>
        <ellipse cx="17" cy="152" rx="3" ry="4.5" fill="#bcd6dd" opacity="0.85" />
      ...
      <g transform="translate(300,120)">
        <path d="M-52 140 q-34 12 -44 34" stroke="#e6c39a" strokeWidth="16" fill="none" strokeLinecap="round" />
        <path d="M86 140 q36 10 46 32" stroke="#e6c39a" strokeWidth="16" fill="none" strokeLinecap="round" />
      ...
      <g transform="translate(300,252)">
        ...
        <path d="M-140 -6 Q-140 52 -104 58 L104 58 Q140 52 140 -6 Z" fill="url(#ab-copper)" />
        <ellipse cx="0" cy="-6" rx="140" ry="20" fill="#c07a3a" />
        <ellipse cx="0" cy="-4" rx="128" ry="15" fill="#4a2c12" />
        <path d="M-116 6 Q-108 40 -86 48" stroke="#e0a35c" strokeWidth="5" fill="none" opacity="0.55" strokeLinecap="round" />
        <g fill="url(#ab-foam)">
