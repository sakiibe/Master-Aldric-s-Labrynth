		...
		>
			...
			<g transform="translate(300,112)">
				...
				<g transform="translate(-116,84) rotate(-24)">
					...
					<g transform="translate(0,-26)">
						...
						<path
							d="M-9 -16 Q0 -25 9 -16 Q6 -10 0 -12 Q-6 -10 -9 -16 Z"
							fill="#e8c05a"
						/>
						<circle cx="-9" cy="-11" r="4" fill="#e8c05a" />
						<circle cx="9" cy="-11" r="4" fill="#e8c05a" />
						<path
							d="M-6 -22 l2 -6 l2 5 l2 -7 l2 7 l2 -5 l2 6 z"
							fill="#FAC775"
						/>
				...
				<g transform="translate(156,86) rotate(22)">
					...
					<g transform="translate(0,-26)">
						...
						<path
							d="M-9 -17 l2 -6 l2 5 l2 -7 l2 7 l2 -5 l2 6 z"
							fill="#e8c05a"
			...
			<g transform="translate(0,344)">
				...
				<g transform="translate(140,-40)">
					...
					<path
						d="M-13 0 h5 v-7 h5 v7 h5 v-7 h5 v7 h5"
						fill="none"
						stroke="#8a8272"
						strokeWidth="6"
					/>
